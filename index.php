    ...
    <div class="flex justify-start items-center h-[30rem]">
        <div class="w-full max-w-md bg-white rounded-xl p-8 shadow-2xl">
            ...
            <p class="text-gray-600 mb-6">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae metus id ipsum placerat facilisis. Donec et metus vel justo tincidunt scelerisque. Donec vitae mauris consectetur, ultricies neque at, gravida sapien.
            </p>
            <div class="flex justify-center">
                <button class="bg-[#80808048] px-8 py-2 md:px-12 md:py-2 rounded-full hover:bg-[#292929] active:bg-red-700 text-white text-sm md:text-lg font-semibold transition duration-300 btn-primary">
                    Learn more
                </button>
            </div>
        </div>
